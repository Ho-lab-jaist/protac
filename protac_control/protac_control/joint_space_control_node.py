...
class ProTacVelocityController(Node):
    def __init__(self):
        ...
        self.velocity_trajectory3 = self.velocity_trajectory_generation(0., 0.4, 0.01)
        self.velocity_trajectory4 = self.velocity_trajectory_generation(0., 0.4, 0.01)

        self.contact = False

    def position_trajectory_generation(self, start_velocity, bound_velocity, step):
    ...
    def timer_callback(self):   
        ...
        if self.contact:
            ...
            self.velocity_jnt3_ = 0.
            self.velocity_jnt4_ = 0.
        else:
        ...
        msg.data = [self.velocity_jnt1_, self.velocity_jnt2_, self.velocity_jnt3_, self.velocity_jnt4_]
